...
<div class="d-grid gap-2 mt-4 abaixo">
	<a id="add-to-cart-btn" href='#' onclick="addCarrinho()" class="btn btn-primary botao-carrinho"><?php echo $texto_botao ?></a>
</div>
					...
					<form action="carrinho.php" method="post">
						<div class="row">
							<div class="col-6">
								...
								<?php if ($id_usuario == "") { ?>
									<div class="group">
										<input onkeyup="buscarNome()" type="text" class="input" name="telefone" id="telefone" 
										required value="<?php echo @$telefone_cliente ?>">
